...
// square 함수: 해시 요소의 value를 제곱
void hash_square(struct hash_elem *e, void *aux);
// triple 함수: 해시 요소의 value를 세제곱
void hash_triple(struct hash_elem *e, void *aux);
// hash_elem에 연결된 data를 삭제
void data_destructor(struct hash_elem *e, void *aux);
...
struct hash *hash_create(hash_hash_func *hash, hash_less_func *less, void *aux);          //hash create함수
void hash_print(struct hash *h);                                                          //hash value들 출력
