...
void display(void) {
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(20.0f, 0.0f, 50.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-100.0f, 0.0f, -30.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(80.0f, 0.0f, -60.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, -90.0f * TO_RADIAN, glm::vec3(0.0f, 1.0f, 0.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, -90.0f * TO_RADIAN, glm::vec3(1.0f, 0.0f, 0.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(0.15f, 0.15f, 0.15f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	glUniformMatrix4fv(loc_ModelViewMatrix_TXPS, 1, GL_FALSE, &ModelViewMatrix[0][0]);
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(90.0f, 0.0f, 20.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(3.0f, 3.0f, 3.0f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-90.0f, 0.0f, 90.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(100.0f, 0.0f, 90.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, -90.0f * TO_RADIAN, glm::vec3(0.0f, 1.0f, 0.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(0.07f, 0.07f, 0.07f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	glUniformMatrix4fv(loc_ModelViewMatrix_TXPS, 1, GL_FALSE, &ModelViewMatrix[0][0]);
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-40.0f, 0.0f, -60.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(50.0f, 0.0f, 240.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, -90.0f * TO_RADIAN, glm::vec3(1.0f, 0.0f, 0.0f));
	...
	if (0) {
		ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(150.0f, 0.0f, -50.0f));
		ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(50.0f, 50.0f, 50.0f));
	}
	else {
		ModelViewMatrix = glm::scale(ViewMatrix, glm::vec3(50.0f, 50.0f, 50.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-40.0f, 0.0f, 10.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(40.0f, 40.0f, 40.0f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-100.0f, 70.0f, -40.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(120.0f, 0.0f, 0.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(30.0f, 30.0f, 30.0f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(80.0f, 0.0f, -120.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-110.0f, 66.0f, 80.0f));
	...
	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-60.0f, 0.0f, -140.0f));
	ModelViewMatrix = glm::scale(ModelViewMatrix, glm::vec3(10.0f, 10.0f, 10.0f));
	ModelViewProjectionMatrix = ProjectionMatrix * ModelViewMatrix;
	ModelViewMatrixInvTrans = glm::inverseTranspose(glm::mat3(ModelViewMatrix));
	glUniformMatrix4fv(loc_ModelViewProjectionMatrix_TXPS, 1, GL_FALSE, &ModelViewProjectionMatrix[0][0]);
...
void timer_scene(int value) {
	...
	cur_frame_nathan = timestamp_scene % N_NATHAN_FRAMES;
...
void keyboard(unsigned char key, int x, int y) {
	...
	case 'f':
		...
		break;
	case 't':
		flag_texture_mapping = !flag_texture_mapping;
		glUseProgram(h_ShaderProgram_TXPS);
